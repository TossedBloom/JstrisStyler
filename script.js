...
(() => {
  ...
  a.forEach((o) => {
    o.styles && (s.textContent += o.styles);
  });
  ...
  const l =
    ...
    R = {
      ...
      handler: () => {
        R.isHidden
          ? ((K.textContent = "Show players"),
            g == null || g.classList.remove("hide-players"))
          : ((K.textContent = "Hide players"),
            g == null || g.classList.add("hide-players")),
          (R.isHidden = !R.isHidden);
      },
    },
    g = document.querySelector("#gameFrame"),
    K = document.createElement("li");
  K.textContent = "Hide players";
  K.setAttribute("role", "button");
  K.setAttribute("aria-pressed", R.isHidden ? "true" : "false");
  ...
  const e = {
      isCentered: !1,
      handler: () => {
        (e.isCentered = !e.isCentered),
          e.isCentered
            ? ((A.textContent = "Uncenter board"),
              C == null || C.classList.add("center-board"))
            : ((A.textContent = "Center board"),
              C == null || C.classList.remove("center-board"));
      },
    },
    C = document.querySelector("#gameFrame"),
    A = document.createElement("li");
  A.textContent = "Center board";
  A.setAttribute("role", "button");
  A.setAttribute("aria-pressed", e.isCentered ? "true" : "false");
  ...
  const U = {
      ...
      handler: (o) => {
        U.hidden++,
          U.hidden == 6 && (U.hidden = 0),
          (o.style.top = d[U.hidden].top),
          (o.style.height = d[U.hidden].height);
      },
    },
    Q = document.createElement("div");
  Q.id = "previewCover";
  var r;
  (r = document.querySelector("#rstage")) == null || r.appendChild(Q);
  const d = [
      { top: "0px", height: "0px" },
  ...
  const t = {
      ...
      handler: () => {
        t.isHidden
          ? ((i.textContent = "Show chat"),
            F == null || F.classList.remove("hide-chat"))
          : ((i.textContent = "Hide chat"),
            F == null || F.classList.add("hide-chat")),
          (t.isHidden = !t.isHidden);
      },
    },
    F = document.querySelector("#gameFrame"),
    i = document.createElement("li");
  i.textContent = "Hide chat";
  i.setAttribute("role", "button");
  i.setAttribute("aria-pressed", t.isHidden ? "true" : "false");
  ...
  const v = () => {
    ...
    h = () => {
      const o = document.querySelector("#gc"),
        n = v(),
        f = P();
      o == null || o.prepend(n),
        o == null || o.prepend(f),
